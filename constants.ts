...
// Icons - Optimized 20x20
// IMPORTANT: This plane points UP (North) by default for correct rotation math.
export const PLANE_SVG_STRING = `
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0px 0px 6px rgba(255, 255, 255, 0.6));">
<path d="M12 2L2 22L12 18L22 22L12 2Z" fill="#EDEDED" stroke="#0F0F0F" stroke-width="1.5" stroke-linejoin="round"/>
</svg>
`;
...
export const NOISE_ICONS = {
  ...
  OCEAN: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12c.6.533.9.8 1.2.8.6 0 .9-.8 1.5-.8.6 0 .9.8 1.5.8.6 0 .9-.8 1.5-.8.6 0 .9.8 1.5.8.6 0 .9-.8 1.5-.8.6 0 .9.8 1.5.8.6 0 .9-.8 1.5-.8"/></svg>`,
};